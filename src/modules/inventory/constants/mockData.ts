...
export const mockProjects: Project[] = [
  ...
  {
    id: 'p3',
    name: 'Grand Vista Towers',
    builderId: 'b1',
    rera: 'PRM/MH/RERA/998877',
  ...
  {
    id: 'p4',
    name: 'Eco Oasis Villas',
    builderId: 'b2',
    rera: 'PRM/MH/RERA/554433',
